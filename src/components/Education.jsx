  ...
  return (
    ...
    >
      <div className="WRAPPER mt-10">
        ...
        <div
          className="EDUCATION flex gap-10 justify-between flex-row-reverse max-sm:flex-col-reverse max-sm:items-center"
          data-aos="fade-right"
        >
          {/* Lottie Animation */}
          <Lottie
            ...
            loop={true}
            className="max-w-[500px] w-full max-sm:max-w-[300px] max-sm:mb-5 shadow-xl rounded-xl border border-[#00040f]"
          />

          {/* College Details */}
          <div className="max-w-[520px] mt-[52px] p-7 max-sm:p-4 max-sm:mt-2">
            <div className="flex gap-5 max-sm:flex-col max-sm:items-center text-center max-sm:text-left">
              <img
                src={JEC}
                alt="JEC"
                className="w-[90px] h-[90px] max-sm:w-[70px] max-sm:h-[70px]"
              />
              <h1 className="bg-clip-text text-transparent bg-gradient-to-r from-amber-500 via-orange-600 to-yellow-500 dark:from-[#ff6600] dark:to-slate-100 font-semibold text-2xl max-sm:text-[18px] tracking-wide max-w-[300px]">
